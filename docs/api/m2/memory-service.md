...
`memory_deletion_ledger` is the sole physical persistence for deletion tombstones. The term “tombstone” is conceptual only; there is no separate `memory_tombstones` entity.

...
- A reference-type journal entry points only to an active, accessible, same-journal `JournalMediaReference` with the matching media kind. A media reference grants no access to the underlying media.
